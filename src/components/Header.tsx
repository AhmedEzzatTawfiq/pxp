    ...
    <header className="w-full h-16 bg-black border-b-[1px] border-b-lightText/40 sticky z-50 -top-1">
      <Container className="h-full flex items-center justify-between gap-5 lg:gap-10">
        ...
        {session?.user ? (
          ...
          <Link
            href={"/signin"}
            className="hover:bg-blue-600 hover:text-white text-blue-600 border-blue-600 border-[1px] hoverEffect lg:ml-12 bg-blue-50 px-3 text-sm sm:px-6 py-1 sm:pt-1 sm:pb-2 rounded-full sm:w-28 text-center sm:text-xl"
          >
            Sign in
          </Link>
        )}
